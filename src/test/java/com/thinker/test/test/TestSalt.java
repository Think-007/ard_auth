...
public class TestSalt {
	public static void main(String[] args) {
		...
		// 调用 org.apache.shiro.crypto.hash.Md5Hash.Md5Hash(Object source, Object
		// salt, int hashIterations)构造方法实现MD5盐值加密
		Md5Hash mh = new Md5Hash(source, salt, hashIterations);
		// 打印最终结果
		System.out.println(mh.toString());

		/*
		 * 调用org.apache.shiro.crypto.hash.SimpleHash.SimpleHash(String
